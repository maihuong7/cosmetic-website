      ...
      <div class="container">
         <div class="row">
            <div class="col-md-2 col-sm-2">
               <div class="logo"><a href="http://localhost/cosmetic/"><img src="public/frontend/images/logo.png" width="100px" alt="FlatShop"></a></div>
            </div>
                     ...
                     <div class="col-md-3">
                        ...
                        ?>
                              ...
                              <ul class="dropdown-menu">
                                 ...
                                 <li><a class="dropdown-item" href="users/lichsu-thanhtoan.php">Đơn hàng của tôi</a></li>
            ...
            <div class="header_bottom">
                              ...
                              <div class="cart-item">
                                 ...
                                 <div class="item-description">
                                    ...
                                    <p>
                                       ...
                                       <br>
                                       Giá
                                       <span class="light-red"><?php echo number_format($data_cart1['price'], 0, ',', '.'); ?><sup> vnđ</sup></span>
                                    </p>
                                 </div>
                                 <div class="right">
                                    <p  class="price"><?php echo number_format($totol_price, 0, ',', '.'); ?><sup> vnđ</sup></p>
               ...
               <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                     <li>
                        <a href="http://localhost/cosmetic/">Trang chủ</a>
                     </li>
                     <?php 
